import { Component, OnInit, ViewChild, HostListener, ViewChildren, QueryList,ViewContainerRef, ElementRef } from '@angular/core';
...
export class PagesComponent implements OnInit { 
  ...
  @ViewChildren(PerfectScrollbarDirective,{read: ElementRef}) pss: QueryList<PerfectScrollbarDirective>;
